...
export function ShellPane({ cid, name, disabled, disabledMessage }: Props) {
  ...
  return (
    <ResizablePanelGroup orientation="horizontal" className="min-h-[65vh] w-full">
      ...
      <ResizablePanel defaultSize={78} minSize={40}>
        {activeSid ? (
          <ShellView sessionId={activeSid} className="h-full px-1" />
        ) : (
